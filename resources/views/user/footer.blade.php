...
<script defer src="{{ asset('dashboard/assets/js/alpine-persist.min.js') }}"></script>
<script defer src="{{ asset('dashboard/assets/js/alpine-collaspe.min.js') }}"></script>
...
<!-- Mirrored from html. Prime Summit Bank .sbthemes.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Dec 2024 15:15:16 GMT -->
</html>
