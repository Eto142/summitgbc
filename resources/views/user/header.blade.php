...
<!-- Mirrored from html. Prime Summit Bank .sbthemes.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Dec 2024 15:14:44 GMT -->
...
{{--                                     
    ...
    <form method="POST" action="{{ route('user.logout') }}">
        @csrf
        <button type="submit"
            class="flex items-center w-full text-left !py-3 text-danger hover:text-red-600 transition-colors duration-200">
            <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
            >
                <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 6.75L21 12m0 0l-3.75 5.25M21 12H9M3 3v18" />
            </svg>
            Logout
        </button>
    </form>
