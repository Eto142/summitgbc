                    ...
                    <div class="h-full bg-white dark:bg-[#0e1726]">
                        <div class="flex items-center justify-between px-4 py-3">
                            <a href="index.html" class="main-logo flex shrink-0 items-center">
                                                              <  <img src="../img/logo/logo2.png"" alt="logo" class="img-responsive">
                        ...
                        >
                            ...
                            <li class="nav-item">
                                <ul>
									...
									<li class="nav-item">
                                        <a href="setting.php" class="group">
                                            <div class="flex items-center">
...
<div class="main-content flex flex-col min-h-screen">
                ...
                <div class="animate__animated p-6" :class="[$store.app.animation]">
                    ...
                    <div x-data="knowledge">
						...
						<center>
						   <!--- <img width="150px" src="https://static.vecteezy.com/system/resources/previews/010/979/408/original/money-transfer-3d-illustration-png.png">--->
					
						
                            <h3 style="font-size:18px">
                                
                                                                
                                A deposit of 50.00  will be made into your account number () once <br>confirmation has been received. Please note that the deposit will not be <br>available until confirmation has been received.
                                </h3>
                            <div class="text-lg font-medium text-dark">
                                
                                
                                 <img src="../cp-access/en/pics/btc.jpg" width="200px">
                                <br>
                               Coin Type: Bition Coin (BTC)<br>
							   Wallet address <br>15LMmA6gZzRgrdXD4XU7tZm2fyk9s6qrKZ<br>
								
								 
											   
			   
			   <p id="here">29:41<br>Awaiting Payment</p>
...
setInterval(function(){
   ...
   <div class="mt-8 flex flex-col sm:flex-row items-center justify-center gap-6">
                ...
                <div class="mt-auto p-6 pt-0 text-center dark:text-white-dark ltr:sm:text-left rtl:sm:text-right">
                    © <span id="footer-year">2022</span>.  Prime Summit Bank
